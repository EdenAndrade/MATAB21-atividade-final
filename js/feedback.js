const DIAGNOSTICS = {
  enigma1: {
    success: [
      'PORTA LÓGICA CORRETA. CIRCUITO RESTAURADO.',
      'SINAL VERIFICADO. TABELA VERDADE CONFIRMADA.',
      'MÓDULO DE CIRCUITO REATIVADO COM SUCESSO.',
    ],
    error: [
  ...
  enigma2: {
    success: [
      'ENTIDADE IDENTIFICADA. MAPA DE DADOS RESTAURADO.',
      'RELACIONAMENTO RECONECTADO. INTEGRIDADE DO MODELO VERIFICADA.',
      'DER COMPLETO. DADOS RECUPERADOS COM SUCESSO.',
    ],
    error: [
  ...
  enigma3: {
    success: [
      'LOOP CONTROLADO. RECURSÃO ESTABILIZADA.',
      'ERRO IDENTIFICADO. ALGORITMO DEPURADO.',
      'CÓDIGO CORRIGIDO. MÓDULO COGNITIVO RESTAURADO.',
    ],
    error: [
